    ...
    <tr>
        <td>
            <table class="details">
                ...
                <tr>
                    <th>Room :</th>
                    <td><?php if (FormatDate($child->finish,'U')>=date('U') && FormatDate($child->start,'U')<=date('U')) {
        ...
        <td>
            <table class="details">
                ...
                <tr>
                    <th>Nationality :</th>
                    <td><?php $query = 'select name from nationality where id=%s limit 1;';
                        $query = sprintf($query,Db::SqlFormat($child->nationality,'int'));
                        $data_lookup = Db::GetData($query);
                        echo FormatText($data_lookup['name']); ?></td>
                </tr>
                <tr>
                    <th>Religion :</th>
                    <td><?php $query = 'select name from religion where id=%s limit 1;';
                ...
                <tr>
                    <th>Keyworker :</th>
                    <td><?php if (!empty($child->keyworker)) {

...
<h2>BackUp Keyworker</h2>

<?php
$query = 'select surname,forename,format_date(dob) as dob,id,age_months(dob) AS age';
$query .= ' from child';
...
<?php } else { ?>
    ...
    <p>This member of staff is not a backup keyworker for any children.</p>
